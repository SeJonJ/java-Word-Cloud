		...
		$SelectBox.append(
			$J('<option/>', {value: "koreana"} ).text( '한국어' )
				...
				$J('<option/>', {value: "polish"} ).text( 'Polski (폴란드어)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "portuguese"} ).text( 'Português (포르투갈어)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "romanian"} ).text( 'Română (루마니아어)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "schinese"} ).text( '简体中文 (간체 중국어)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "swedish"} ).text( 'Svenska (스웨덴어)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "tchinese"} ).text( '繁體中文 (정체 중국어)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "thai"} ).text( 'ไทย (태국어)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "turkish"} ).text( 'Türkçe (터키어)' )
			);
